...
<div class="container">
    <div>
        <form>
            <input bind:value={name} required name="name" placeholder="User name" type="text">
            <input bind:value={email} required name="email" placeholder="Email address" type="email">
            <input bind:value={password} required name="password" placeholder="Password" type="password">
            <input bind:value={license} required name="license" placeholder="Car license" type="number">
